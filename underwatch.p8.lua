...
function ai_movement_behavior(entity)
	...
	elseif entity.pos.x > 312-rnd(10) then --and entity.class != "support" then
		...
		if type(entity.target) == "table" and entity.target.isalive then
			...
			if entity.isjumping != true and (rnd(10) < 1 or (entity.velocity.x < 0.2 and entity.velocity.x > -0.2) or entity.pos.y > entity.target.pos.y) then
...
function draw_map()
	...
	if currmap and game.currsong != currmap.song then
		game.currsong = currmap.song
...

...

...

...
001000002307024370183701a3701f370213701c0702307024070180701a0701f0701c070210702307024070180701a0701c070210701f070240701c0702407021070180701a070180701a0701c0701f07021070
...

